...
{% include docs/v2.16/forseti-server-gcp-required-roles.md %}
...
{% include docs/v2.16/forseti-client-gcp-required-roles.md %}
...
{% include docs/v2.16/cloud-foundation-forseti-required-roles.md %}
