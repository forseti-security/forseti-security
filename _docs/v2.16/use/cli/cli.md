...
For more information, see the [client-server architecture of Forseti]({% link _docs/v2.16/concepts/architecture.md %}).
...
*  To learn how to use the CLI commands for specific components, see the other [CLI guides]({% link _docs/v2.16/use/cli/index.md %}).
