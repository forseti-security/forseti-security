...
[Sending Email with SendGrid](https://cloud.google.com/appengine/docs/v1.1/standard/python/mail/sendgrid).
...
1.  Create a general
    [API Key](https://sendgrid.com/docs/v1.1/User_Guide/Settings/api_keys.html).
...
disable SendGrid
[Open Tracking](https://sendgrid.com/docs/v1.1/User_Guide/Settings/tracking.html#-Open-Tracking).
