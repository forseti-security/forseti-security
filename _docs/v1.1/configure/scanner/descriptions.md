...
Scanner]({% link _docs/v1.1/configure/configuring-forseti.md %}#configuring-scanner).
...
[configuring
Inventory]({% link _docs/v1.1/configure/configuring-forseti.md %}#configuring-inventory).
