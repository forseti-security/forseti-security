...
1.  [Create a new user](https://cloud.google.com/sql/docs/v1.1/mysql/create-manage-users#creating),
    e.g. `forseti_user`,
    with [read/write privileges](https://cloud.google.com/sql/docs/v1.1/mysql/users?hl=en_US#privileges)
...
1.  [Create a new database](https://cloud.google.com/sql/docs/v1.1/mysql/create-manage-databases#creating_a_database),
    e.g. `forseti_security`.
1.  Use the [SQL Proxy](https://cloud.google.com/sql/docs/v1.1/mysql-connect-proxy#connecting_mysql_client)
...
["Configuring Forseti"]({% link _docs/v1.1/configure/configuring-forseti.md %}) 
