...
[How to deploy Forseti Security]({% link _docs/v1.1/howto/deploy/index.md %})

- [Deploy Forseti on Google Cloud Platform]({% link _docs/v1.1/howto/deploy/gcp-deployment.md %})
- [Set up Forseti for Development Environment]({% link _docs/v1.1/howto/deploy/dev-setup.md %})
- [Change a Deployment]({% link _docs/v1.1/howto/deploy/change-gcp-deployment.md %})

[Enable or change features of Forseti Security]({% link _docs/v1.1/howto/configure/index.md %})
