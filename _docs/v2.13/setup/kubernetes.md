...
[forseti-security/install/scripts/k8s_setup_forseti.sh](https://github.com/forseti-security/forseti-security/blob/release-2.13.0/install/scripts/k8s_setup_forseti.sh)
```
...
https://github.com/forseti-security/forseti-security/blob/release-2.13.0/install/scripts/k8s_setup_forseti.sh | Example script to spin up cluster and deploy Forseti to GKE
