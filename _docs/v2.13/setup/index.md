...
**[Installing Forseti Security]({% link _docs/v2.13/setup/install.md %})**
...
**[Upgrading Forseti Security]({% link _docs/v2.13/setup/upgrade.md %})**

Get new features and update your GCP deployment by upgrading your Forseti Security installation
to the latest version.

**[Deploy Forseti Security Manually]({% link _docs/v2.13/setup/manual.md %})**

Deploy Forseti manually on GCP.

**[Deploy Forseti Security on Kubernetes]({% link _docs/v2.13/setup/forseti-on-gke.md %})**
