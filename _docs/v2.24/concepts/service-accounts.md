...
{% include docs/v2.24/forseti-server-gcp-required-roles.md %}


Users can grant additional roles to the `forseti-server-gcp` service account to utilize optional features:

{% include docs/v2.24/forseti-server-gcp-optional-roles.md %}
...
{% include docs/v2.24/forseti-client-gcp-required-roles.md %}
...
{% include docs/v2.24/cloud-foundation-forseti-required-roles.md %}
...
{% include docs/v2.24/forseti-enforcer-gcp-required-roles.md %}
