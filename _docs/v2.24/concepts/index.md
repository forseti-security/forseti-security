...
**[Architecture]({% link _docs/v2.24/concepts/architecture.md %})**

Learn about how information flows through Forseti.

**[Best Practices]({% link _docs/v2.24/concepts/best-practices.md %})**
