...
Run the Forseti [Installer]({% link _docs/v2.24/setup/install.md %}).
...
1. **NEW for version 2.12.0+**: You can use the `composite_root_resources`
   ...
   See [Configure Inventory]({% link _docs/v2.24/configure/inventory/index.md %})
   for more details.
...
1. Saving changes.
   ...
   1. Upload `forseti_conf_server.yaml` [to GCS bucket]({% link _docs/v2.24/configure/general/index.md %}#moving-configuration-to-cloud-storage).
