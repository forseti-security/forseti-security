...
{% include docs/v2.20/forseti-server-gcp-required-roles.md %}
...
{% include docs/v2.20/forseti-client-gcp-required-roles.md %}
...
{% include docs/v2.20/cloud-foundation-forseti-required-roles.md %}
