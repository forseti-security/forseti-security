...
[`domain_super_admin_email`]({% link _docs/v2.20/configure/inventory/index.md %})
...
information, see
[Moving configuration to Cloud Storage]({% link _docs/v2.20/configure/general/index.md %}).
