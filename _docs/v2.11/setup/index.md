...
**[Installing Forseti Security]({% link _docs/v2.11/setup/install.md %})**
...
**[Upgrading Forseti Security]({% link _docs/v2.11/setup/upgrade.md %})**

Get new features and update your GCP deployment by upgrading your Forseti Security installation
to the latest version.

**[Deploy Forseti Security Manually]({% link _docs/v2.11/setup/manual.md %})**
