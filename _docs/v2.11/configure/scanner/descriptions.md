...
[configure Scanner]({% link _docs/v2.11/configure/scanner/index.md %}) to execute
...
[enable the service account with the required API scopes in your G Suite admin control panel]({% link _docs/v2.11/configure/inventory/gsuite.md %}#enable-the-service-account-in-your-g-suite-admin-control-panel).
