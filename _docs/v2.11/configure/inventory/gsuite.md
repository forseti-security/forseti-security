...
[`domain_super_admin_email`]({% link _docs/v2.11/configure/inventory/index.md %})
...
information, see
[Moving configuration to Cloud Storage]({% link _docs/v2.11/configure/general/index.md %}).
