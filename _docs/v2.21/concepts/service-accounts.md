...
{% include docs/v2.21/forseti-server-gcp-required-roles.md %}
...
{% include docs/v2.21/forseti-client-gcp-required-roles.md %}
...
{% include docs/v2.21/cloud-foundation-forseti-required-roles.md %}
...
{% include docs/v2.21/forseti-enforcer-gcp-required-roles.md %}
