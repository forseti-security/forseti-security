 ...
 * [Forseti v2 configuration]({% link _docs/v2.12/configure/general/index.md %}) is different than v1. You
...
1. [Install the latest v2 instance]({% link _docs/v2.12/setup/install.md %}).
...
To learn more about these fields, see [Configure]({% link _docs/v2.12/configure/general/index.md %}).
...
Follow instructions [here]({% link _docs/v2.12/configure/general/index.md %}#configuring-settings) to 
...
1. Rule files updates:  
    ...
    1. BigQuery rule syntax has been [updated (backward compatible)]({% link _docs/v2.12/configure/scanner/rules.md %}#bigquery-rules).
...
Example command: `gcloud compute instances reset forseti-server-vm-70ce82f --zone us-central1-c`
1. Repeat step `3-8` for Forseti client.
1. To enable the [External Project Access Scanner]({% link _docs/v2.12/configure/scanner/descriptions.md %}#external-project-access-scanner), go to your Google Admin
...
1. Configuration file `forseti_conf_server.yaml` updates:  
    ...
    **Notifier**
    ...
    - Update the `resources` section to add the External Project Access Scanner:
        ...
        ```
1. Rule files updates:
    - Google Groups default rule has been [updated]({% link _docs/v2.12/configure/scanner/rules.md %}#google-group-rules) 
...
1. Rule files updates:
  ...
  - External Project Access rule syntax has been [updated to include whitelisting users]({% link _docs/v2.12/configure/scanner/rules.md %}#external-project-access-rules).
...
* Customize [Inventory]({% link _docs/v2.12/configure/inventory/index.md %}) and
[Scanner]({% link _docs/v2.12/configure/scanner/index.md %}).
* Configure Forseti to send
[email notifications]({% link _docs/v2.12/configure/notifier/index.md %}#email-notifications).
* Enable [G Suite data collection]({% link _docs/v2.12/configure/inventory/gsuite.md %})
