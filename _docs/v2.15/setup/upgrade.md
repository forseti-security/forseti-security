...
To learn more about these fields, see [Configure]({% link _docs/v2.15/configure/general/index.md %}).
...
{% endcapture %}
{% include site/zippy/item.html title="Upgrading 2.14.0 to 2.15.0" content=upgrading_2_14_0_to_2_15_0 uid=15 %}
