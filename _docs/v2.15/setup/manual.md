...
[automated installer]({% link _docs/v2.15/setup/install.md %})
...
{% include docs/v2.15/required-apis.md %}
...
service account, see
[the server service account]({% link _docs/v2.15/concepts/service-accounts.md %}#the-server-service-account).
...
[Configuring Forseti]({% link _docs/v2.15/configure/general/index.md %}).

### G Suite Integration

To integrate G Suite, you'll need to enable domain-wide delegation in G Suite.
For more information, see how to
[enable G Suite access]({% link _docs/v2.15/configure/inventory/gsuite.md %})
...
For information about the roles you need to assign to the Forseti server
service account, see
[the client service account]({% link _docs/v2.15/concepts/service-accounts.md %}#the-client-service-account).
...
* Learn how to [use Forseti]({% link _docs/v2.15/configure/inventory/index.md %}).
