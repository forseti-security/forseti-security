...
Example command: `gcloud compute instances reset forseti-server-vm-70ce82f --zone us-central1-c`
1. Repeat step `3-8` for Forseti client.
1. To enable the [External Project Access Scanner]({% link _docs/v2.17/configure/scanner/descriptions.md %}#external-project-access-scanner), go to your Google Admin
...
1. Rule files updates:
    - Google Groups default rule has been [updated]({% link _docs/v2.17/configure/scanner/rules.md %}#google-group-rules) 
...
1. Rule files updates:
  ...
  - External Project Access rule syntax has been [updated to include whitelisting users]({% link _docs/v2.17/configure/scanner/rules.md %}#external-project-access-rules).
...
* Customize [Inventory]({% link _docs/v2.17/configure/inventory/index.md %}) and
...
* Enable [G Suite data collection]({% link _docs/v2.17/configure/inventory/gsuite.md %})
