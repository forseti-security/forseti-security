...
* the [standard installer]({% link _docs/v2.17/setup/install.md %})
...
[forseti-security/install/scripts/k8s_setup_forseti.sh](https://github.com/forseti-security/forseti-security/blob/release-2.17.0/install/scripts/k8s_setup_forseti.sh)
```
