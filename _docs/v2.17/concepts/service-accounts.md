...
{% include docs/v2.17/forseti-server-gcp-required-roles.md %}
...
{% include docs/v2.17/forseti-client-gcp-required-roles.md %}
...
{% include docs/v2.17/cloud-foundation-forseti-required-roles.md %}
...
{% include docs/v2.17/forseti-enforcer-gcp-required-roles.md %}
