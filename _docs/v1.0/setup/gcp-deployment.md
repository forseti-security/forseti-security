...
**This is the manual version of the [Quickstart]({% link _docs/v1.0/setup/gcp-deployment.md %}).**
...
{% include docs/v1.0/deployment_prerequisites.md %}
...
Refer to ["Configuring Forseti"]({% link _docs/v1.0/configure/configuring-forseti.md %}) 
...
Customize your Forseti rules by following [this guide]({% link _docs/v1.0/configure/scanner/rules.md %}).
