...
[next section]({% link _docs/v1.0/configure/gsuite-group-collection.md %}#enable-the-service-account-in-your-g-suite-admin-control-panel).
...
["Move Configuration to GCS"]({% link _docs/v1.0/setup/gcp-deployment.md %}) 
for details on how to do this.

## Deploying to GCP with G Suite Google Groups collection

If you
[created a deployment]({% link _docs/v1.0/setup/gcp-deployment.md %})
