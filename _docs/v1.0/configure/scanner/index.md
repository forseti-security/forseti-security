...
to run, see [Configuring Forseti: Configuring Scanner]({% link _docs/v1.0/configure/configuring-forseti.md %}#configuring-scanner).
...
To run Forseti Scanner, follow the process below:
  ...
  1. Run the [inventory data import]({% link _docs/v1.0/configure/inventory/index.md %}#executing-the-inventory-loader) 
...
- Read more about [configuring Scanner]({% link _docs/v1.0/configure/configuring-forseti.md %}#configuring-scanner).
- Learn about the [different scanners]({% link _docs/v1.0/configure/scanner/descriptions.md %}) available in Forseti.
- Learn about [defining rules]({% link _docs/v1.0/configure/scanner/rules.md %}).
- Read about how Scanner outputs [policy violations]({% link _docs/v1.0/configure/scanner/policy-violations.md %}).
