...
[transformed to a data model]({% link _docs/v2.23/concepts/models.md %})
...
[configured]({% link _docs/v2.23/configure/inventory/index.md %}) and the
proper [GCP]({% link _docs/v2.23/concepts/service-accounts.md %}) and
[G Suite]({% link _docs/v2.23/configure/inventory/gsuite.md %}) access is set up
...
## What's next
* Learn about [configuring Inventory]({% link _docs/v2.23/configure/inventory/index.md %}).
