...
{% include docs/v2.23/forseti-server-gcp-required-roles.md %}
...
{% include docs/v2.23/forseti-client-gcp-required-roles.md %}
...
{% include docs/v2.23/cloud-foundation-forseti-required-roles.md %}
...
{% include docs/v2.23/forseti-enforcer-gcp-required-roles.md %}
