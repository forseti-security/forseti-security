...
the [detailed guide on setting up Forseti on-GKE]({% link _docs/v2.23/setup/forseti-on-gke.md %}).
...
{% include docs/v2.23/setup-script-credentials-gce.md %}

#### APIs
For this module to work, you need the following APIs enabled on the Forseti project:

{% include docs/v2.23/forseti-terraform-setup-apis.md %}
...
[configure Forseti]({% link _docs/v2.23/configure/index.md %}). Some of the commonly used features are 
listed below:

- [Enable G Suite Scanning]({% link _docs/v2.23/configure/inventory/gsuite.md %})
- [Enable Cloud Security Command Center Notifications]({% link _docs/v2.23/configure/notifier/index.md %}#cloud-scc-notification)
...
{% include docs/v2.23/forseti-terraform-sa-roles.md %}
...
* Learn how to customize
  [Inventory]({% link _docs/v2.23/configure/inventory/index.md %}) and
  [Scanner]({% link _docs/v2.23/configure/scanner/index.md %}).
* Configure Forseti Notifier to send
  [email notifications]({% link _docs/v2.23/configure/notifier/index.md %}#email-notifications).
* Enable
  [G Suite data collection]({% link _docs/v2.23/configure/inventory/gsuite.md %})
  for processing by Forseti.
* Learn how to [configure Forseti to run from non-organization
  root]({% link _docs/v2.23/configure/general/non-org-root.md %}).
