...
If your Forseti deployment was previously deployed with Deployment Manager, please see the [migration documentation]({% link _docs/v2.23/setup/migrate.md %}) on migrating to Terraform.  Following these steps will also result in an upgraded deployment of Forseti.
...
Follow the steps documented in the [migration documentation]({% link _docs/v2.23/setup/migrate.md %}) to import existing Terraform state.  Following these steps will also result in an upgraded deployment of Forseti.
...
* Customize [Inventory]({% link _docs/v2.23/configure/inventory/index.md %}) and
...
* Enable [G Suite data collection]({% link _docs/v2.23/configure/inventory/gsuite.md %})
