 ...
 * [Forseti v2 configuration]({% link _docs/v2.4/configure/general/index.md %}) is different than v1. You
...
1. [Install the latest v2 instance]({% link _docs/v2.4/setup/install.md %}).
...
To learn more about these fields, see [Configure]({% link _docs/v2.4/configure/general/index.md %}).
...
Follow instructions [here]({% link _docs/v2.4/configure/general/index.md %}#configuring-settings) to 
...
1. Rule files updates:  
    ...
    1. BigQuery rule syntax has been [updated (backward compatible)]({% link _docs/v2.4/configure/scanner/rules.md %}#bigquery-rules).
...
* Customize [Inventory]({% link _docs/v2.4/configure/inventory/index.md %}) and
[Scanner]({% link _docs/v2.4/configure/scanner/index.md %}).
* Configure Forseti to send
[email notifications]({% link _docs/v2.4/configure/notifier/index.md %}#email-notifications-with-sendgrid).
* Enable [G Suite data collection]({% link _docs/v2.4/configure/inventory/gsuite.md %})
