...
After you **[set up Forseti Security]({% link _docs/v2.3/setup/index.md %})**,
use these guides to configure its features.

---

**[General configuration]({% link _docs/v2.3/configure/general/index.md %})**
...
**[Configuring Inventory]({% link _docs/v2.3/configure/inventory/index.md %})**
...
**[Configuring Scanner]({% link _docs/v2.3/configure/scanner/index.md %})**
...
**[Configuring Notifier]({% link _docs/v2.3/configure/notifier/index.md %})**
...
**[Enabling G Suite data collection]({% link _docs/v2.3/configure/inventory/gsuite.md %})**
