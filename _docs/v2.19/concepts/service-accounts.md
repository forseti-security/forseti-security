...
{% include docs/v2.19/forseti-server-gcp-required-roles.md %}
...
{% include docs/v2.19/forseti-client-gcp-required-roles.md %}
...
{% include docs/v2.19/cloud-foundation-forseti-required-roles.md %}
