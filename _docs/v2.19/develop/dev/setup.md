...
{% include docs/v2.19/deployment-prerequisites.md %}

### Setting up Cloud SQL

{% include docs/v2.19/setup-cloudsql.md %}
...
For more information, see [Configuring Forseti]({% link _docs/v2.19/configure/general/index.md %}).
...
* To learn about more CLI commands, see [Use]({% link _docs/v2.19/use/index.md %}).
