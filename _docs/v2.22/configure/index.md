...
After you **[set up Forseti Security]({% link _docs/v2.22/setup/index.md %})**,
use these guides to configure its features.

---

**[General configuration]({% link _docs/v2.22/configure/general/index.md %})**
...
**[Configuring Inventory]({% link _docs/v2.22/configure/inventory/index.md %})**
...
**[Configuring Scanner]({% link _docs/v2.22/configure/scanner/index.md %})**
...
**[Configuring Notifier]({% link _docs/v2.22/configure/notifier/index.md %})**
...
**[Configuring Real-Time Enforcer]({% link _docs/v2.22/configure/real-time-enforcer/index.md %})**

Configure Real-Time Enforcer to automatically remediate non-compliant configurations in targeted 
Google Cloud Platform (GCP) resources.

**[Enabling G Suite data collection]({% link _docs/v2.22/configure/inventory/gsuite.md %})**
