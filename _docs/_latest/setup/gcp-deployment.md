...
**This is the manual version of the [Quickstart]({% link _docs/latest/setup/gcp-deployment.md %}).**
...
Customize your Forseti rules by following [this guide]({% link _docs/latest/configure/scanner/rules.md %}).
