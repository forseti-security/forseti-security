...
**This is the manual version of the [Quickstart]({% link _docs/_latest/setup/gcp-deployment.md %}).**
...
{% include docs/_latest/deployment_prerequisites.md %}
...
Refer to ["Configuring Forseti"]({% link _docs/_latest/configure/configuring-forseti.md %}) 
...
Customize your Forseti rules by following [this guide]({% link _docs/_latest/configure/scanner/rules.md %}).
