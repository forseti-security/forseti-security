...
Before running this scanner, please [enable the service account in your G Suite admin control panel]({% link /_docs/latest/configure/inventory/gsuite.md#enable-the-service-account-in-your-g-suite-admin-control-panel %}). 