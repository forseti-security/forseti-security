...
Scanner]({% link _docs/latest/configure/configuring-forseti.md %}#configuring-scanner).
...
[configuring
Inventory]({% link _docs/latest/configure/configuring-forseti.md %}#configuring-inventory).
