...
To learn more about the Forseti model, see [Models]({% link _docs/v2.14/concepts/models.md %}).
...
* Learn how to query the data model using [Explain]({% link _docs/v2.14/use/cli/explain.md %}).
