 ...
 * [Forseti v2 configuration]({% link _docs/v2.14/configure/general/index.md %}) is different than v1. You
...
1. [Install the latest v2 instance]({% link _docs/v2.14/setup/install.md %}).
...
To learn more about these fields, see [Configure]({% link _docs/v2.14/configure/general/index.md %}).
...
Follow instructions [here]({% link _docs/v2.14/configure/general/index.md %}#configuring-settings) to 
...
Example command: `gcloud compute instances reset forseti-server-vm-70ce82f --zone us-central1-c`
1. Repeat step `3-8` for Forseti client.
1. To enable the [External Project Access Scanner]({% link _docs/v2.14/configure/scanner/descriptions.md %}#external-project-access-scanner), go to your Google Admin
...
1. Configuration file `forseti_conf_server.yaml` updates:  
    ...
    **Notifier**
    ...
    - Update the `resources` section to add the External Project Access Scanner:
        ...
        ```
1. Rule files updates:
    - Google Groups default rule has been [updated]({% link _docs/v2.14/configure/scanner/rules.md %}#google-group-rules) 
...
1. Gsuite scope updates:
   ...
   - Add GSuite scope `https://www.googleapis.com/auth/apps.groups.settings` to your Forseti server service 
     ...
     GSuite access, you can follow the instructions [here]({% link _docs/v2.14/configure/inventory/gsuite.md }) to do it.
...
* Customize [Inventory]({% link _docs/v2.14/configure/inventory/index.md %}) and
[Scanner]({% link _docs/v2.14/configure/scanner/index.md %}).
* Configure Forseti to send
[email notifications]({% link _docs/v2.14/configure/notifier/index.md %}#email-notifications).
* Enable [G Suite data collection]({% link _docs/v2.14/configure/inventory/gsuite.md %})
