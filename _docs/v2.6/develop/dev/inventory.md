...
see [cloud_sql.py]({% link _docs/v2.6/develop/reference/_modules/google/cloud/forseti/common/gcp_api/cloudsql.html %}).

## Step 2: Create an iterator

Edit
[google/cloud/forseti/services/inventory/base/gcp.py]({% link _docs/v2.6/develop/reference/_modules/google/cloud/forseti/services/inventory/base/gcp.html %})
...
Edit
[google/cloud/forseti/services/inventory/base/resources.py]({% link _docs/v2.6/develop/reference/_modules/google/cloud/forseti/services/inventory/base/resources.html %})
...
1. Edit
[google/cloud/forseti/services/model/importer/importer.py]({% link _docs/v2.6/develop/reference/_modules/google/cloud/forseti/services/model/importer/importer.html %})
