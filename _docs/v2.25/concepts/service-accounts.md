...
{% include docs/v2.25/cloud-foundation-forseti-required-roles.md %}
...
{% include docs/v2.25/forseti-server-gcp-required-roles.md %}


Users can grant additional roles to the `forseti-server-gcp` service account to utilize optional features:

{% include docs/v2.25/forseti-server-gcp-optional-roles.md %}
...
{% include docs/v2.25/forseti-client-gcp-required-roles.md %}
