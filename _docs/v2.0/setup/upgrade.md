 ...
 * [Forseti v2 configuration]({% link _docs/v2.0/configure/general/index.md %}) is different than v1 so
...
1. [Install the latest v2 instance]({% link _docs/v2.0/setup/install.md %}).
...
To learn more about these fields, see [Configure]({% link _docs/v2.0/configure/general/index.md %}).
...
* Customize [Inventory]({% link _docs/v2.0/configure/inventory/index.md %}) and
[Scanner]({% link _docs/v2.0/configure/scanner/index.md %}).
* Configure Forseti to send
[email notifications]({% link _docs/v2.0/configure/notifier/index.md %}#email-notifications-with-sendgrid).
* Enable [G Suite data collection]({% link _docs/v2.0/configure/inventory/gsuite.md %})
