...
{% include docs/v2.0/deployment-prerequisites.md %}

### Setting up Cloud SQL

{% include docs/v2.0/setup-cloudsql.md %}
...
For more information, see [Configuring Forseti]({% link _docs/v2.0/configure/general/index.md %}).
...
* To learn about more CLI commands, see [Use]({% link _docs/v2.0/use/index.md %}).
