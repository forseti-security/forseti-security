...
{% include docs/v2.18/forseti-server-gcp-required-roles.md %}
...
{% include docs/v2.18/forseti-client-gcp-required-roles.md %}
...
{% include docs/v2.18/cloud-foundation-forseti-required-roles.md %}
