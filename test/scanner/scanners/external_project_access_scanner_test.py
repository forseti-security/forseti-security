...
from test.common.gcp_api.test_data import fake_crm_responses
from test.services.api_tests.inventory_test import TestServiceConfig
from test.services.inventory.storage_test import ResourceMock
