...
["Forseti Service Accounts"]({% link _docs/v1.0/concepts/forseti-service-accounts.md %})._
...
["Enabling GSuite Google Groups Collection"]({% link _docs/v1.0/configure/gsuite-group-collection.md %}).
...
Enable each of the required APIs by running the following command:
  ...
  {% include docs/v1.0/required_apis.md %}
