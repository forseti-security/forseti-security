...
chown -R $USER {forseti_home}/configs {forseti_home}/rules {forseti_home}/setup/installer/scripts/run_forseti.sh
...
bash ./setup/installer/scripts/initialize_forseti_services.sh
...
sudo su $USER -c "$FORSETI_HOME/setup/installer/scripts/run_forseti.sh"
(echo "{run_frequency} $FORSETI_HOME/setup/installer/scripts/run_forseti.sh") | crontab -u $USER -
