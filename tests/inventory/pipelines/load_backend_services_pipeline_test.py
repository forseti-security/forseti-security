...
from google.cloud.forseti.common.data_access import backend_service_dao as bsdao
...
from google.cloud.forseti.inventory.pipelines import load_backend_services_pipeline
...
class LoadBackendServicesPipelineTest(ForsetiTestCase):
