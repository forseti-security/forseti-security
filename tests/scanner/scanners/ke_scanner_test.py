    ...
    def test_run_scanner(self, mock_output_results, mock_logger):
        ...
        expected_violations = [
            ...
            {'rule_name': 'explicit whitelist, fail',
             ...
             'rule_index': 1,
             'violation_type': 'KE_VIOLATION',
             'violation_data': {'violation_reason': "name has value fake-cluster-no-node-pools, which is not in the whitelist (['real-cluster'])", 'cluster_name': 'fake-cluster-no-node-pools', 'project_id': 'fake-project', 'full_name': 'organization/12345/project/fake-project/kubernetes_cluster/{}/'.format(NO_NODE_POOLS_ID)},
             'resource_type': 'kubernetes_cluster'},
            ...
            {'rule_name': 'multiple values, pass',
             ...
             'rule_index': 4,
             'violation_type': 'KE_VIOLATION',
             'violation_data': {'violation_reason': "name has value fake-cluster-no-node-pools, which is not in the whitelist (['real-cluster', 'fake-cluster'])", 'cluster_name': 'fake-cluster-no-node-pools', 'project_id': 'fake-project', 'full_name': 'organization/12345/project/fake-project/kubernetes_cluster/{}/'.format(NO_NODE_POOLS_ID)},
             'resource_type': 'kubernetes_cluster'},
            ...
            {'rule_name': 'multiple values, fail',
             ...
             'rule_index': 5,
             'violation_type': 'KE_VIOLATION',
             'violation_data': {'violation_reason': "name has value fake-cluster-no-node-pools, which is not in the whitelist (['real-cluster', 'imaginary-cluster'])", 'cluster_name': 'fake-cluster-no-node-pools', 'project_id': 'fake-project', 'full_name': 'organization/12345/project/fake-project/kubernetes_cluster/{}/'.format(NO_NODE_POOLS_ID)},
             'resource_type': 'kubernetes_cluster'},
            ...
            {'rule_name': 'use projection to look for a list, pass',
             ...
             'violation_data': {'violation_reason': "nodePools[*].config.imageType has value None, which is not in the whitelist ([['COS', 'COS']])", 'cluster_name': 'fake-cluster-no-node-pools', 'project_id': 'fake-project', 'full_name': 'organization/12345/project/fake-project/kubernetes_cluster/{}/'.format(NO_NODE_POOLS_ID)},
             'resource_type': 'kubernetes_cluster'},
            ...
            {'rule_name': 'explicit whitelist, fail',
             ...
             'full_name': 'organization/12345/project/fake-project/kubernetes_cluster/{}/'.format(FAKE_CLUSTER_ID),
             ...
             'rule_index': 1,
             'violation_type': 'KE_VIOLATION',
             'violation_data': {'violation_reason': "name has value fake-cluster, which is not in the whitelist (['real-cluster'])", 'cluster_name': 'fake-cluster', 'project_id': 'fake-project', 'full_name': 'organization/12345/project/fake-project/kubernetes_cluster/{}/'.format(FAKE_CLUSTER_ID)},
             'resource_type': 'kubernetes_cluster'},
            {'rule_name': 'explicit blacklist, fail',
             ...
             'rule_index': 3,
             'violation_type': 'KE_VIOLATION',
             'violation_data': {'violation_reason': "name has value fake-cluster, which is in the blacklist (['fake-cluster'])", 'cluster_name': 'fake-cluster', 'project_id': 'fake-project', 'full_name': 'organization/12345/project/fake-project/kubernetes_cluster/{}/'.format(FAKE_CLUSTER_ID)},
             'resource_type': 'kubernetes_cluster'},
            {'rule_name': 'multiple values, fail',
             'resource_name': 'fake-cluster',
             'resource_data': '{"addonsConfig": {"httpLoadBalancing": {}, "istioConfig": {"auth": "AUTH_MUTUAL_TLS"}, "kubernetesDashboard": {"disabled": true}}, "name": "fake-cluster", "nodePools": [{"config": {"imageType": "COS"}, "name": "default-pool", "version": "1.7.11-gke.1"}, {"config": {"imageType": "COS"}, "name": "secondary-pool", "version": "1.7.11-gke.1"}], "selfLink": "fake-cluster.com"}',
             'full_name': 'organization/12345/project/fake-project/kubernetes_cluster/{}/'.format(FAKE_CLUSTER_ID), 'resource_id': FAKE_CLUSTER_ID, 'rule_index': 5, 'violation_type': 'KE_VIOLATION', 'violation_data': {'violation_reason': "name has value fake-cluster, which is not in the whitelist (['real-cluster', 'imaginary-cluster'])", 'cluster_name': 'fake-cluster', 'project_id': 'fake-project', 'full_name': 'organization/12345/project/fake-project/kubernetes_cluster/{}/'.format(FAKE_CLUSTER_ID)}, 'resource_type': 'kubernetes_cluster'},
            {'rule_name': 'use projection, look for a list, fail',
             'resource_name': 'fake-cluster',
             'resource_data': '{"addonsConfig": {"httpLoadBalancing": {}, "istioConfig": {"auth": "AUTH_MUTUAL_TLS"}, "kubernetesDashboard": {"disabled": true}}, "name": "fake-cluster", "nodePools": [{"config": {"imageType": "COS"}, "name": "default-pool", "version": "1.7.11-gke.1"}, {"config": {"imageType": "COS"}, "name": "secondary-pool", "version": "1.7.11-gke.1"}], "selfLink": "fake-cluster.com"}',
             'full_name': 'organization/12345/project/fake-project/kubernetes_cluster/{}/'.format(FAKE_CLUSTER_ID), 'resource_id': FAKE_CLUSTER_ID, 'rule_index': 8, 'violation_type': 'KE_VIOLATION', 'violation_data': {'violation_reason': "nodePools[*].config.imageType has value ['COS', 'COS'], which is not in the whitelist ([['COS'], ['Ubuntu', 'COS']])", 'cluster_name': 'fake-cluster', 'project_id': 'fake-project', 'full_name': 'organization/12345/project/fake-project/kubernetes_cluster/{}/'.format(FAKE_CLUSTER_ID)}, 'resource_type': 'kubernetes_cluster'},
        ]
