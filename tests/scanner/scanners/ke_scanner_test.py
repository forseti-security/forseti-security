...
class KeScannerTest(unittest_utils.ForsetiTestCase):
    ...
    def test_run_scanner(self, mock_output_results):
        self.scanner.run()
        expected_violations = [
            {'rule_name': 'explicit whitelist, fail', 'resource_data': '{"nodePools": [{"version": "1.7.11-gke.1", "config": {"imageType": "COS"}, "name": "default-pool"}, {"version": "1.7.11-gke.1", "config": {"imageType": "COS"}, "name": "secondary-pool"}], "addonsConfig": {"httpLoadBalancing": {}, "istioConfig": {"auth": "AUTH_MUTUAL_TLS"}, "kubernetesDashboard": {"disabled": true}}, "name": "fake-cluster"}', 'full_name': u'organization/12345/project/fake-project/kubernetes_cluster/fake-cluster/', 'resource_id': u'fake-cluster', 'rule_index': 2, 'violation_type': 'KE_VIOLATION', 'violation_data': {'violation_reason': 'value is not in whitelist', 'cluster_name': u'fake-cluster', 'project_id': u'fake-project', 'full_name': u'organization/12345/project/fake-project/kubernetes_cluster/fake-cluster/'}, 'resource_type': 'kubernetes_cluster'},
            {'rule_name': 'explicit blacklist, fail', 'resource_data': '{"nodePools": [{"version": "1.7.11-gke.1", "config": {"imageType": "COS"}, "name": "default-pool"}, {"version": "1.7.11-gke.1", "config": {"imageType": "COS"}, "name": "secondary-pool"}], "addonsConfig": {"httpLoadBalancing": {}, "istioConfig": {"auth": "AUTH_MUTUAL_TLS"}, "kubernetesDashboard": {"disabled": true}}, "name": "fake-cluster"}', 'full_name': u'organization/12345/project/fake-project/kubernetes_cluster/fake-cluster/', 'resource_id': u'fake-cluster', 'rule_index': 4, 'violation_type': 'KE_VIOLATION', 'violation_data': {'violation_reason': 'value is in blacklist', 'cluster_name': u'fake-cluster', 'project_id': u'fake-project', 'full_name': u'organization/12345/project/fake-project/kubernetes_cluster/fake-cluster/'}, 'resource_type': 'kubernetes_cluster'},
            {'rule_name': 'multiple values, fail', 'resource_data': '{"nodePools": [{"version": "1.7.11-gke.1", "config": {"imageType": "COS"}, "name": "default-pool"}, {"version": "1.7.11-gke.1", "config": {"imageType": "COS"}, "name": "secondary-pool"}], "addonsConfig": {"httpLoadBalancing": {}, "istioConfig": {"auth": "AUTH_MUTUAL_TLS"}, "kubernetesDashboard": {"disabled": true}}, "name": "fake-cluster"}', 'full_name': u'organization/12345/project/fake-project/kubernetes_cluster/fake-cluster/', 'resource_id': u'fake-cluster', 'rule_index': 6, 'violation_type': 'KE_VIOLATION', 'violation_data': {'violation_reason': 'value is not in whitelist', 'cluster_name': u'fake-cluster', 'project_id': u'fake-project', 'full_name': u'organization/12345/project/fake-project/kubernetes_cluster/fake-cluster/'}, 'resource_type': 'kubernetes_cluster'},
            {'rule_name': 'use projection, look for a list, fail', 'resource_data': '{"nodePools": [{"version": "1.7.11-gke.1", "config": {"imageType": "COS"}, "name": "default-pool"}, {"version": "1.7.11-gke.1", "config": {"imageType": "COS"}, "name": "secondary-pool"}], "addonsConfig": {"httpLoadBalancing": {}, "istioConfig": {"auth": "AUTH_MUTUAL_TLS"}, "kubernetesDashboard": {"disabled": true}}, "name": "fake-cluster"}', 'full_name': u'organization/12345/project/fake-project/kubernetes_cluster/fake-cluster/', 'resource_id': u'fake-cluster', 'rule_index': 9, 'violation_type': 'KE_VIOLATION', 'violation_data': {'violation_reason': 'value is not in whitelist', 'cluster_name': u'fake-cluster', 'project_id': u'fake-project', 'full_name': u'organization/12345/project/fake-project/kubernetes_cluster/fake-cluster/'}, 'resource_type': 'kubernetes_cluster'},
        ]
