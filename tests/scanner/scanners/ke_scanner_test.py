    ...
    def test_run_scanner(self, mock_output_results):
        ...
        expected_violations = [
            {'rule_name': 'explicit whitelist, fail',
             ...
             'resource_data': '{"nodePools": [{"version": "1.7.11-gke.1", "config": {"imageType": "COS"}, "name": "default-pool"}, {"version": "1.7.11-gke.1", "config": {"imageType": "COS"}, "name": "secondary-pool"}], "addonsConfig": {"httpLoadBalancing": {}, "istioConfig": {"auth": "AUTH_MUTUAL_TLS"}, "kubernetesDashboard": {"disabled": true}}, "name": "fake-cluster", "selfLink": "fake-cluster.com"}',
