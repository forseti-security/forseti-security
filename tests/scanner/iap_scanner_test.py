        ...
        mock_csv_writer.assert_called_once_with(
            data=[{
                ...
                'violation_data': {
                    ...
                    'resource_name': u'bs1_different_port',
                ...
                'violation_data': {
                    'iap_enabled_violation': 'True',
                    'resource_name': u'bs1_different_network',
                    'alternate_services_violations': '',
                    'direct_access_sources_violations': ''
                },
                'violation_type': 'IAP_VIOLATION',
                ...
                'violation_data': {
                    ...
                    'resource_name':
                        u'bs1',
                    'alternate_services_violations':
                        u'foo/bs1_same_backend, foo/bs1_same_instance',
                    'direct_access_sources_violations':
                ...
                'violation_data': {
                    'iap_enabled_violation': 'True',
                    'resource_name': u'bs1_different_instance',
                    'alternate_services_violations': '',
                    'direct_access_sources_violations': ''
                },
                'violation_type': 'IAP_VIOLATION',
                ...
                'violation_data': {
                    'iap_enabled_violation': 'True',
                    'resource_name': u'bs1_same_backend',
                    'alternate_services_violations': '',
                    'direct_access_sources_violations': ''
                },
                'violation_type': 'IAP_VIOLATION',
                ...
                'violation_data': {
                    'iap_enabled_violation': 'True',
                    'resource_name': u'bs1_same_instance',
                    'alternate_services_violations': '',
                    'direct_access_sources_violations': ''
                },
                'violation_type': 'IAP_VIOLATION',
